...
# 11/4/2025
# MNIST data handler class for downloading, loading, and preprocessing
# Note: modified from the 05/mnist_data.py file to change the label loading
#       to one-hot encoding
class MnistData:
    ...
    def get_dataset(self):
        ...
        for key in ['train_labels', 'test_labels']:
            self.dataset[key] = self._to_one_hot(self.dataset[key], 10)
